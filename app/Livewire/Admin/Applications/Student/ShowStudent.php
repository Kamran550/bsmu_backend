...
use App\Mail\FinalAcceptanceLetterEnglishTurkishMail;
...
class ShowStudent extends Component
{
       ...
       public function sendFinalAcceptanceLetterPoland()
    {
        try {
            ...
            Mail::to($this->student->email)->send(new FinalAcceptanceLetterEnglishTurkishMail($this->student, $user, $plainPassword));

            $this->student->application->update([
                'document_status' => DocumentStatusEnum::CERTIFICATE_ENGLISH_TURKISH_LETTER->value,
            ]);
            $this->student->load('application');

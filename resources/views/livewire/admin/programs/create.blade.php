    ...
    <form wire:submit="save">
        ...
        <div class="mb-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="modal-name-en" wire:model="name_en"
                    ...
                    placeholder="For example: Computer Science, Economics, Law" autofocus>
                @error('name_en')
            ...
            <div class="mb-4">
                ...
                <input type="text" id="modal-name-tr" wire:model="name_tr"
        ...
        <div class="mb-6">
            ...
            <select id="modal-degree" wire:model.live="degree_id"
        ...
        <div class="mb-6">
            ...
            <select id="modal-faculty" wire:model="faculty_id"
        ...
        <div class="mb-6">
            ...
            <input type="number" id="modal-price" wire:model="price_per_year" min="0" step="1"
        ...
        <div class="mb-6">
            ...
            <div class="space-y-3">
                ...
                <label class="flex items-center">
                    <input type="checkbox" wire:model="study_language_en"
                ...
                <!-- Turkish Language -->
                <label class="flex items-center">
                    <input type="checkbox" wire:model="study_language_tr"
                        class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
        ...
        <div class="mb-6">
            <label class="flex items-center">
                <input type="checkbox" wire:model="is_thesis"
                    class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">

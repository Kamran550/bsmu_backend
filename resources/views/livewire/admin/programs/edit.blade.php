    ...
    @if ($program)
        ...
        <form wire:submit="update">
            ...
            <div class="mb-6">
                ...
                <select id="edit-modal-degree" wire:model.live="degree_id"
            ...
            <div class="mb-6">
                ...
                <select id="edit-modal-faculty" wire:model="faculty_id"
            ...
            <div class="mb-6">
                ...
                <input type="number" id="edit-modal-price" wire:model="price_per_year" min="0" step="1"

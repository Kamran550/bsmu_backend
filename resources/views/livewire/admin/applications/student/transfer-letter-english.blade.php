...
<body>
    ...
    <div class="watermark">
        @php
            $watermarkPath = public_path('images/BSMU-simvol.png');
    ...
    <div class="header">
        @php
            $logoPath = public_path('images/bsmu-logo-tam.png');
        ...
        <div class="contact-info">
            <strong>Email:</strong> international@bsmu.edu.rs<br>
            <strong>Phone:</strong> +32 483 38 31 70<br>
    ...
    <div class="document-title">
        BALKAN SCIENCE AND MANAGEMENT UNIVERSITY<br>
        TRANSFER ACCEPTANCE LETTER
    </div>

    <div class="department">
        International Student Affairs Directorate
    </div>
    ...
    <div class="content">
        <p>
            ...
            program at Balkan Science and Management University for the
            @php

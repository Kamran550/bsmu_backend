...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #1a1a1a; margin-bottom: 10px;">BSMU</h1>
            <h2 style="color: #1a1a1a; margin-top: 0;">BALCAN SCIENCE AND MANAGEMENT UNIVERSITY</h2>
        </div>

        <p>Dear <strong>{{ $student->first_name }} {{ $student->last_name }}</strong>,</p>

        <p>
            Congratulations! We are delighted to inform you that you have been granted <strong
                style="color: #2ecc71;">100% Scholarship</strong> conditional acceptance at World Peace University (WPU).
            The conditional acceptance letter with detailed information is attached to this email in PDF format.
        </p>

        <div
            style="background-color: #d4edda; border: 1px solid #c3e6cb; border-radius: 5px; padding: 15px; margin: 20px 0;">
        ...
        <p>
            <strong>Important:</strong> Please read the attached conditional acceptance letter carefully. It contains
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; font-size: 12px; color: #666;">
            <p>Sincerely,<br>
                <strong>Prof. Dr. Eraytun Koralmaz</strong><br>
                Director of International Student Office<br>
                <strong>Balkan Science and Management University</strong>
            </p>

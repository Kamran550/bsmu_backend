...
<body
    ...
    <div style="background-color: #f8f9fa; border-radius: 10px; padding: 30px; margin-bottom: 20px;">
        ...
        <p style="font-size: 16px; margin-bottom: 15px;">
            We would like to share an important update regarding your transfer application to Balkan Science and Management University.
        </p>
    ...
    <div
        ...
        <p style="margin: 5px 0;">
            © {{ date('Y') }} Balkan Science and Management University. All rights reserved.
        </p>
        <p style="margin: 5px 0;">
            Belgrade, Serbia
        </p>

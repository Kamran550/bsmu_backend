...
<body
    ...
    <div style="background-color: #f8f9fa; border-radius: 10px; padding: 30px; margin-bottom: 20px;">
        ...
        <p style="font-size: 16px; margin-bottom: 15px;">
            Balkan Bilim ve Yönetim Üniversitesi'ne transfer başvurunuz ile ilgili önemli bir güncelleme paylaşmak
            istiyoruz.
        </p>
        ...
        <div style="background-color: #e7f3ff; border-radius: 8px; padding: 20px; margin: 25px 0;">
            ...
            <p style="margin: 5px 0; font-size: 14px;">
                <strong>E-posta:</strong> <a href="mailto:international@bsmu.org"
                    style="color: #007bff; text-decoration: none;">international@bsmu.org</a>
            </p>
            <p style="margin: 5px 0; font-size: 14px;">
                <strong>Telefon:</strong> +32 483 38 31 70
            </p>
            <p style="margin: 5px 0; font-size: 14px;">
    ...
    <div
        ...
        <p style="margin: 5px 0;">
            © {{ date('Y') }} Balkan Bilim ve Yönetim Üniversitesi. Tüm hakları saklıdır.
        </p>
        <p style="margin: 5px 0;">
            Belgrade, Serbia
        </p>
